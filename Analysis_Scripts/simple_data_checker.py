...
treadmill_path = r"D:\CAH_motivationSC_cohort\CAH3\Session_5\beh\1770060783treadmill.csv"
...
BOUT_THRESHOLD_CM_S  = 5.0   # cm/s — minimum speed to count as moving
...
ax_bout.plot(time_arr, speed_filt_cm, color='seagreen', linewidth=0.8,
             label='Median + Butterworth filtered')
